...
DATAforPLOT(1:30,6:10) = [DATA.EPI.COST.(metric).reshape0750,DATA.GRE.COST.(metric).reshape0750,DATA.NLREG.COST.(metric).reshape0750,DATA.SPE.COST.(metric).reshape0750,DATA.NONE.COST.(metric).reshape0750];
DATAforPLOT(1:45,11:15) = [DATA.EPI.COST.(metric).reshape1000,DATA.GRE.COST.(metric).reshape1000,DATA.NLREG.COST.(metric).reshape1000,DATA.SPE.COST.(metric).reshape1000,DATA.NONE.COST.(metric).reshape1000];
...
switch metric
    case 'bbr'
        ylim([0.25 0.85]), ylabel('BBR cost function')
    case 'normmi'
        ylim([-1.245 -1.135]), ylabel('Normalized mutual information')
end
